 ...
 * @author Hainguyen
 */
public class GoiDichVuGUI extends javax.swing.JDialog {

    java.awt.Frame parent;
    DefaultTableModel dtm;

    /**
     * Creates new form GoiDichVuGUI
     *
     * @param parent
     * @param modal
     */
    public GoiDichVuGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadcbLoaiDV();
        //loadDichVuAll();
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GoiDichVuGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GoiDichVuGUI dialog = new GoiDichVuGUI(new javax.swing.JFrame(), true);
