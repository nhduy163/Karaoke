 ...
 * @author Hainguyen
 */
public class PhongGUI_Sua extends javax.swing.JDialog {

    /**
     * Creates new form PhongGUI_Sua
     *
     * @param parent
     * @param modal
     */
    public PhongGUI_Sua(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public PhongGUI_Sua(java.awt.Frame parent, boolean modal, String MaPhong) {
        super(parent, modal);
        initComponents();
        loadcbLoaiPhong();
        loadcbTinhTrang();
        lbMaPhong.setText(MaPhong);
        PhongDTO p = PhongBUS.getPhong(Integer.parseInt(lbMaPhong.getText()));
        tfTenPhong.setText(p.getTenPhong());
        tfNgay.setText("" + p.getGiaGioNgay());
        tfDem.setText("" + p.getGiaGioDem());
        for (int j = 0; j < cbLoaiPhong.getItemCount(); j++) {
            Object item = cbLoaiPhong.getItemAt(j);
            int value = ((ComboItem) item).getValue();
            if (p.getLoaiPhong() == value) {
    ...
    public void loadcbTinhTrang() {
        ...
        try {
            ...
            ResultSet rs = my.executeQuery(sql);
            while (rs.next()) {
                String TenLDV = rs.getString("TenTTP");
                int MaLDV = rs.getInt("MaTTP");
                if (MaLDV == 1 || MaLDV == 4) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thay đổi thông tin phòng");
        ...
        jLabel9.setText("Giá giờ ngày");

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel10.setText("Giá giờ đêm");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbMaPhong, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(tfDem, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(tfNgay, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        if (PhongBUS.checkTenPhong(tfTenPhong)) {
            if (PhongBUS.checkGiaGio(tfNgay)) {
                if (PhongBUS.checkGiaGio(tfDem)) {
                    ...
                    boolean chk = phong.UpdatePhong(MaPhong, TenPhong, MaLP, TinhTrang, Ngay, Dem);
                    if (chk == true) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhongGUI_Sua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PhongGUI_Sua dialog = new PhongGUI_Sua(new javax.swing.JFrame(), true);
